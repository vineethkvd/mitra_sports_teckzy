...
abstract class _LoginModel implements LoginModel {
  const factory _LoginModel(
      ...
      @JsonKey(name: 'data') final UserData? data}) = _$LoginModelImpl;
...
class _$UserDataImpl implements _UserData {
  const _$UserDataImpl({@JsonKey(name: 'user_id') this.userId});
...
abstract class _UserData implements UserData {
  const factory _UserData({@JsonKey(name: 'user_id') final int? userId}) =
      _$UserDataImpl;

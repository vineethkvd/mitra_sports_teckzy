...
mixin _$Data {
  ...
  @JsonKey(name: 'images_name')
  String? get imagesName => throw _privateConstructorUsedError;
...
abstract class $DataCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'images_name') String? imagesName});
}
    ...
    return _then(_value.copyWith(
      imageId: freezed == imageId
          ...
          : imageId // ignore: cast_nullable_to_non_nullable
              as int?,
      imagesName: freezed == imagesName
          ? _value.imagesName
          : imagesName // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$DataImpl implements _Data {
  const _$DataImpl(
      {@JsonKey(name: 'image_id:') this.imageId = 0,
      @JsonKey(name: 'images_name') this.imagesName = ''});
  ...
  @override
  String toString() {
    return 'Data(imageId: $imageId, imagesName: $imagesName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.imagesName, imagesName) ||
                other.imagesName == imagesName));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, imageId, imagesName);
...
abstract class _Data implements Data {
  const factory _Data(
      ...
      @JsonKey(name: 'images_name') final String? imagesName}) = _$DataImpl;

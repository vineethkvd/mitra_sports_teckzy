...
mixin _$GenderList {
  ...
  @JsonKey(name: 'gender_status')
  int? get genderStatus => throw _privateConstructorUsedError;
...
abstract class $GenderListCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'gender_status') int? genderStatus});
}
...
class _$GenderListImpl implements _GenderList {
  const _$GenderListImpl(
      ...
      @JsonKey(name: 'gender_status') this.genderStatus = 0});
  ...
  @override
  @JsonKey(name: 'gender_status')
  final int? genderStatus;

  @override
  String toString() {
    return 'GenderList(genderId: $genderId, genderName: $genderName, genderStatus: $genderStatus)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, genderId, genderName, genderStatus);
...
abstract class _GenderList implements GenderList {
  const factory _GenderList(
          ...
          @JsonKey(name: 'gender_status') final int? genderStatus}) =
      _$GenderListImpl;
